...
TEST(GildedRoseTest, backstage_pass_long_before_sell_date) {
  ...
  auto items = UpdateQualityForItemWith(
      11, 10, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(11, items[0].quality);
}
...
TEST(GildedRoseTest, backstage_pass_medium_close_to_sell_date_upper_bound) {
  ...
  auto items = UpdateQualityForItemWith(
      10, 10, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(12, items[0].quality);
}

TEST(GildedRoseTest,
     backstage_pass_medium_close_to_sell_date_upper_bound_at_max_quality) {

  auto items = UpdateQualityForItemWith(
      10, 50, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(50, items[0].quality);
}
...
TEST(GildedRoseTest, backstage_pass_medium_close_to_sell_date_lower_bound) {
  ...
  auto items = UpdateQualityForItemWith(
      6, 10, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(12, items[0].quality);
}

TEST(GildedRoseTest,
     backstage_pass_medium_close_to_sell_date_lower_bound_at_max_quality) {

  auto items = UpdateQualityForItemWith(
      6, 50, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(50, items[0].quality);
}
...
TEST(GildedRoseTest, backstage_pass_very_close_to_sell_date_upper_bound) {
  ...
  auto items = UpdateQualityForItemWith(
      5, 10, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(13, items[0].quality);
}

TEST(GildedRoseTest,
     backstage_pass_very_close_to_sell_date_upper_bound_at_max_quality) {

  auto items = UpdateQualityForItemWith(
      5, 50, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(50, items[0].quality);
}
...
TEST(GildedRoseTest, backstage_pass_very_close_to_sell_date_lower_bound) {
  ...
  auto items = UpdateQualityForItemWith(
      1, 10, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(13, items[0].quality);
}

TEST(GildedRoseTest,
     backstage_pass_very_close_to_sell_date_lower_bound_at_max_quality) {

  auto items = UpdateQualityForItemWith(
      1, 50, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(50, items[0].quality);
}
...
TEST(GildedRoseTest, backstage_pass_on_sell_date) {
  ...
  auto items = UpdateQualityForItemWith(
      0, 10, "Backstage passes to a TAFKAL80ETC concert");
  EXPECT_EQ(0, items[0].quality);
}
